        ...
        <div>
            <div className=' Banner-main animate__animated animate__fadeInLeft  capitalize text-5xl text-wrap leading-tight  text-[#272341] font-bold  flex items-center justi fy-center h-screen flex-wrap ml-8  lg:justify-start lg:te xt-7xl lg:pl-36'>
                ...
                <button 
                    ...
                    className='capitalize animate__animated animate__fadeInLeft animate__delay-1s w-40 text-2xl font-normal text-[#2d64b6] border-[#3d9add] border-2 rounded-lg p-2 relative overflow-hidden group'>
                    ...
                    <a className="relative z-10 text-[#2d64b6] group-hover:text-white transition-colors duration-300">
                        See More
                    </a>
                </button>
